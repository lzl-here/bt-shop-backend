module github.com/lzl-here/bt-shop-backend/apps/user
...
require (
	...
	github.com/lzl-here/bt-shop-backend/common v0.0.0-20250213070217-72fc00db05ab
	github.com/lzl-here/bt-shop-backend/kitex_gen v0.0.0-20250213040549-d7f6789be546
