...
type GetPersonRsp struct {
	...
	Data  *GetPersonRsp_PersonData `protobuf:"bytes,4,opt,name=data,proto3" form:"data" json:"data,omitempty" query:"data"`                    // 响应体数据
}
...
type GetPersonRsp_PersonData struct {
	...
	Age       int32  `protobuf:"varint,3,opt,name=age,proto3" form:"age" json:"age,omitempty" query:"age"`
	...
	DeletedAt string `protobuf:"bytes,9,opt,name=deleted_at,json=deletedAt,proto3" form:"deleted_at" json:"deleted_at,omitempty" query:"deleted_at"`
}
