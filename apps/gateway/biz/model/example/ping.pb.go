...
type PingReq struct {
	...
	Uid uint64 `protobuf:"varint,1,opt,name=uid,proto3" form:"uid" json:"uid,omitempty" query:"uid"`
}
...
type PingRsp struct {
	...
	Data  *PingRsp_PingData `protobuf:"bytes,4,opt,name=data,proto3" form:"data" json:"data,omitempty" query:"data"`                    // 响应体数据
}
...
type PingRsp_PingData struct {
	...
	UpdatedAt string `protobuf:"bytes,4,opt,name=updated_at,json=updatedAt,proto3" form:"updated_at" json:"updated_at,omitempty" query:"updated_at"`
	DeletedAt string `protobuf:"bytes,5,opt,name=deleted_at,json=deletedAt,proto3" form:"deleted_at" json:"deleted_at,omitempty" query:"deleted_at"`
}
...
var file_example_ping_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x65, 0x64, 0x41, 0x74, 0x42, 0x44, 0x5a, 0x42, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	...
	0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
